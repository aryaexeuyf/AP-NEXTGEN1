...
-- Helper fade wrapper – semua elemen splash mulai di posisi off-screen/transparan
local SplashElems = {}  -- list elemen yang perlu di-fade-out nanti

local function SplashFadeIn(lbl, propName, delay, dur)
    -- propName: "TextTransparency" atau "BackgroundTransparency" atau "ImageTransparency"
    table.insert(SplashElems, {obj=lbl, prop=propName})
    spawn(function()
        wait(delay or 0)
        Tween(lbl, {[propName]=0}, dur or 0.4, Enum.EasingStyle.Quart)
    end)
end
...
SplashBG.ZIndex                 = 200
SplashBG.ClipsDescendants       = false
SplashBG.Parent                 = SG

-- Overlay gelap solid (tidak pakai UIGradient agar BackgroundTransparency bisa di-tween)
-- Cukup warna gelap polos

-- Garis dekorasi atas (mulai width = 0, di-tween melebar)
local SplashLineTop = Instance.new("Frame")
SplashLineTop.Size              = UDim2.new(0, 0, 0, 2)
SplashLineTop.Position          = UDim2.new(0.5, 0, 0, 85)
SplashLineTop.AnchorPoint       = Vector2.new(0.5, 0.5)
...
do
    local g = Instance.new("UIGradient")
    g.Color    = ColorSequence.new(T.Yellow, T.Blue)
    g.Rotation = 0
    g.Parent   = SplashLineTop
end

-- Garis dekorasi bawah
local SplashLineBtm = Instance.new("Frame")
SplashLineBtm.Size              = UDim2.new(0, 0, 0, 2)
SplashLineBtm.Position          = UDim2.new(0.5, 0, 1, -85)
SplashLineBtm.AnchorPoint       = Vector2.new(0.5, 0.5)
SplashLineBtm.BackgroundColor3  = T.Blue
SplashLineBtm.BorderSizePixel   = 0
SplashLineBtm.ZIndex            = 201
SplashLineBtm.Parent            = SplashBG
do
    local g = Instance.new("UIGradient")
    g.Color    = ColorSequence.new(T.Blue, T.Yellow)
    g.Rotation = 0
    g.Parent   = SplashLineBtm
end

-- Container tengah splash
local SplashCenter = Instance.new("Frame")
SplashCenter.Size               = UDim2.new(0, 360, 0, 210)
SplashCenter.Position           = UDim2.new(0.5, -180, 0.5, -105)
SplashCenter.BackgroundTransparency = 1
SplashCenter.ZIndex             = 201
SplashCenter.Parent             = SplashBG

-- Logo text besar – slide dari bawah + fade
local SplashLogo = Instance.new("TextLabel")
SplashLogo.Size               = UDim2.new(1, 0, 0, 68)
SplashLogo.Position           = UDim2.new(0, 0, 0, 36)   -- posisi awal sedikit lebih bawah
...
-- Badge "1" – awalnya invisible (BackgroundTransparency=1 + TextTransparency=1)
local VersionBadge = Instance.new("TextLabel")
VersionBadge.Size                 = UDim2.new(0, 30, 0, 24)
VersionBadge.Position             = UDim2.new(1, 2, 0, 12)
VersionBadge.AnchorPoint          = Vector2.new(0, 0)
VersionBadge.BackgroundColor3     = T.Yellow
VersionBadge.BackgroundTransparency = 1          -- awalnya invisible
VersionBadge.Text                 = "1"
...
-- Sub-judul "By APTECH" – TANPA LetterSpacing (property tidak ada di Roblox)
local SplashSub = Instance.new("TextLabel")
SplashSub.Size               = UDim2.new(1, 0, 0, 22)
SplashSub.Position           = UDim2.new(0, 0, 0, 110)
SplashSub.BackgroundTransparency = 1
SplashSub.Text               = "B Y   A P T E C H"   -- spasi manual sebagai ganti LetterSpacing
...
LoadTrack.Size             = UDim2.new(0, 280, 0, 5)
LoadTrack.Position         = UDim2.new(0.5, -140, 0, 168)
LoadTrack.BackgroundColor3 = Color3.fromRGB(18, 28, 58)
LoadTrack.BorderSizePixel  = 0
LoadTrack.ZIndex           = 202
Round(LoadTrack, 3)
LoadTrack.Parent = SplashCenter

-- Loading fill – TANPA UIGradient (gradient bikin BackgroundTransparency tween rusak)
...
-- Glow dot di ujung fill
local LoadDot = Instance.new("Frame")
LoadDot.Size             = UDim2.new(0, 8, 0, 8)
LoadDot.Position         = UDim2.new(1, -4, 0.5, -4)
LoadDot.BackgroundColor3 = T.Yellow
LoadDot.BorderSizePixel  = 0
Round(LoadDot, 4)
LoadDot.Parent = LoadFill

-- Loading teks
local LoadPct = Instance.new("TextLabel")
LoadPct.Size               = UDim2.new(1, 0, 0, 14)
LoadPct.Position           = UDim2.new(0, 0, 0, 178)
LoadPct.BackgroundTransparency = 1
LoadPct.Text               = "Initializing..."
LoadPct.TextSize           = 9
...
SplashCopy.Position           = UDim2.new(0, 0, 1, -28)
